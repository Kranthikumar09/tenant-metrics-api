...
| Milestone 1 — repo, local env, CI | Buildable modular monolith, Compose, Testcontainers, canonical verify, CI. | `apps/platform-service` boots; Compose/CI still missing | pending |
